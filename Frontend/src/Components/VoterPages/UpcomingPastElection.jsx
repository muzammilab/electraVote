...
export default function UpcomingPastElection() {
...
import { motion } from "framer-motion";
import { Calendar, History, ArrowLeft, User, LogOut, Menu, X } from "lucide-react";
import { Link, useNavigate } from "react-router-dom";
import VoterNavbar from "./VoterNavbar";
...
export default function UpcomingPastElection() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-indigo-900 via-slate-900 to-purple-900 text-white relative overflow-hidden">
      ...
      {/* Header 
      <header className="px-6 py-8 text-center relative z-10">
        <h1 className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-cyan-400 drop-shadow-lg">
          Select Election Type
        </h1>
