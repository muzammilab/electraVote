                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        onClick={() =>
                          navigate(`/voter/${election?._id}/results`)
                        }
...
export default function ClosedElectionsPage() {
  const navigate = useNavigate();

  const [closedElections] = useState([
    {
      id: 1,
    ...
    {
      id: 2,
      name: "Cultural Committee Election 2024",
      date: "2024-07-20",
      winner: {
        name: "Bob Smith",
    ...
    {
      id: 3,
      name: "Sports Council Election 2024",
      date: "2024-06-12",
      winner: {
        name: "Carol Lee",
        party: "Vision Party",
              ...
              <tbody>
                {closedElections.map((election, index) => (
                  <motion.tr
                    ...
                    className="border-t border-white/10 hover:bg-white/10 transition"
                  >
                    <td className="px-6 py-4 text-gray-100">{election.name}</td>
                    <td className="px-6 py-4 text-gray-300">{election.date}</td>
                    <td className="px-6 py-4 flex items-center gap-2 text-gray-100">
                      <img
                        src={election.winner.logo}
                        alt={election.winner.party}
                    ...
                    <td className="px-6 py-4">
                      <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        onClick={() =>
                          navigate("/voter/elections/results/winner")
                        }
                        className="bg-pink-500 hover:bg-pink-600 text-white px-4 py-2 rounded-xl font-semibold shadow-md hover:shadow-pink-500/40 transition cursor-pointer"
                      >
                        View Result
